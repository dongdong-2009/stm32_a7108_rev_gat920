...
/* Private define ---------------------------------------------------------------------------------------*/
#define RO_FLashAddr  	((u32)0x0800E000)									//SN存储地址
#define RO_CROSSIDAddr	((u32)0x0800E004)									//CROSSID存储地址
#define RW_StartAddr     ((u32)0x0800F000)
#define RW_FLashAddr_p1  ((u32)0x0800F000)									//接收器参数保存区
#define RW_FLashAddr_p2  ((u32)0x0800F100)									//地磁配置参数保存区
#define RW_FLashAddr_p3  ((u32)0x0800F200)									//输出端口映射保存区
#define RW_FLashAddr_p4	((u32)0x0800F300)									//网络配置参数保存区
#define EndAddr		((u32)0x0800F400)
...
void init_param_recv_default(u32 sn, u32 crossid)
{
	...
	param_recv.hardware_version		= 0x0305;								//硬件版本号
