...
#define GAT_RO_FLashAddr  	((u32)0x0800E000)								//SN存储地址
#define GAT_RW_StartAddr		((u32)0x0800F400)
#define GAT_RW_FLashAddr_p1	((u32)0x0800F400)								//GAT检测器参数保存区
#define GAT_RW_FLashAddr_p2	((u32)0x0800F500)								//GAT脉冲数据上传配置参数保存区
#define GAT_RW_FLashAddr_p3	((u32)0x0800F600)								//GAT设备配置参数保存区
#define GAT_RW_FLashAddr_p4	((u32)0x0800F700)
#define GAT_EndAddr			((u32)0x0800F800)
#define GAT_PageSize		((u16)0x400)									//RCT6 PageSize = 2048Byte
...
void GAT_FlashErase(u32 StartAddr)
{
	...
	NbrOfPage = (GAT_EndAddr - StartAddr) >> 10;
